            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('books.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="year" name="year" type="number" class="mt-1 block w-full" required />
                    </div>
                    ...
                    <div>
                        ...
                        <x-text-input id="edition_number" name="edition_number" type="text" class="mt-1 block w-full" />
                    </div>
